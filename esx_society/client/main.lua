...
function EnableSociety3MoneyHUDElement()
  ...
  ESX.UI.HUD.RegisterElement('society3_money', 3, 0, society2MoneyHUDElementTpl, {
    money = 0
  })
...
function OpenBossMenu(society, close, options)
  ...
  ---SECONDJOB INCLUDED
	...
	if options.employees then
        table.insert(elements, {label = _U('tertiary_employee_management'), value = 'tertiary_manage_employees'})
	end
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society,
    {
		...
		elseif data.current.value == 'tertiary_manage_employees' then
...
function OpenManageEmployeesMenu3(society)
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'tertiary_manage_employees_' .. society,
    {
      align    = 'right',
	  title    = _U('tertiary_employee_management'),
      elements = {
        {label = _U('employee_list'), value = 'employee_list'},
        {label = _U('recruit'),       value = 'recruit'},
      }
...
function OpenEmployeeList3(society)
  ...
  ESX.TriggerServerCallback('esx_society:getEmployees3', function(employees)
    ...
    local elements = {
      head = {_U('employee'), _U('grade'), _U('actions'),'Principal ou Secondaire ou Troisieme'},
      rows = {}
    }
    ...
    for i=1, #employees, 1 do
      ...
      table.insert(elements.rows, {
        ...
        cols = {
          employees[i].name,
          gradeLabel,
          '{{' .. _U('promote') .. '|promote}} {{' .. _U('fire') .. '|fire}}',"Emploi Troisieme"
        }
      })
    end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.value == 'promote' then
          menu.close()
          OpenPromoteMenu3(society, employee)
        end
